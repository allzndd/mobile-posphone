...
class IncomingTransactionEditScreen extends StatefulWidget {
  final Map<String, dynamic> transaction;

  const IncomingTransactionEditScreen({
    super.key,
    required this.transaction,
  });

  @override
  State<IncomingTransactionEditScreen> createState() =>
      _IncomingTransactionEditScreenState();
}

class _IncomingTransactionEditScreenState
    extends State<IncomingTransactionEditScreen> {
  ...
  void _loadTransactionData() {
    setState(() {
      _selectedCustomerId = widget.transaction['pos_pelanggan_id'];
  ...
  Future<void> _loadCustomers() async {
    ...
    try {
      ...
      setState(() => _customers = response.customers ?? []);
    } catch (e) {
      if (mounted) {
  ...
  Future<void> _updateTransaction() async {
    ...
    try {
      ...
      final response = await IncomingService.updateIncomingTransaction(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: isTotal ? FontWeight.bold : FontWeight.w600,
            color: isTotal ? themeProvider.primaryMain : themeProvider.textPrimary,
          ),
        ),
      ],
    );
                  ...
                  return DropdownMenuItem<int>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Rp ${_formatPrice((product.hargaJual ?? 0).toDouble())}',
                          style: TextStyle(
                            fontSize: 12,
                            color: themeProvider.textSecondary,
                          ),
                ...
                onChanged: (value) {
                  if (value != null) {
                    ...
                    setState(() {
                      ...
                      _productPrice = (product.hargaJual ?? 0).toDouble();
                    });
                  }
                },
                decoration: InputDecoration(
