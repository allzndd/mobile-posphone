...
class _ExpenseTransactionCreateScreenState
  ...
  void initState() {
    super.initState();
    // Don't generate invoice - let backend handle it
    // _generateDefaultInvoice();
    _loadCategories();
    _loadStores();
  }

  // Invoice will be auto-generated by backend
  ...
  Future<void> _saveTransaction() async {
    ...
    try {
      ...
      print('  - Invoice: Auto-generated by backend');
      ...
      final response = await ExpenseTransactionService.createExpenseTransaction(
        ...
        invoice: null, // Let backend auto-generate invoice
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              hintText: 'Auto-generated (EXP-20260214-0001)',
