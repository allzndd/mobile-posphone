            ...
            child: Row(
              ...
              children: [
                _buildNavItem(
                  ...
                  label: 'History',
                  index: 21,
                  isSelected: widget.selectedIndex == 21,
                ),
                _buildNavItem(
                  context: context,
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildSubmenuItem(
                            ...
                            color: Colors.red,
                            index: 17,
                            isSelected: widget.selectedIndex == 17,
                          ),
                          const Divider(height: 1),
                          _buildSubmenuItem(
                            context: context,
                          ...
                          _buildSubmenuItem(
                            ...
                            title: 'RAM',
                            subtitle: 'Manage RAM specifications',
                            color: Colors.lightBlue,
                            index: 19,
                            isSelected: widget.selectedIndex == 19,
                          ),
                          const Divider(height: 1),
                          _buildSubmenuItem(
                            context: context,
                            ...
                            title: 'Storage',
                            subtitle: 'Manage storage options',
                            color: Colors.brown,
                            index: 20,
                            isSelected: widget.selectedIndex == 20,
                          ),
                          const Divider(height: 1),
                          _buildSubmenuItem(
                            context: context,
