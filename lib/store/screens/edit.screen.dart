...
class _StoreEditScreenState extends State<StoreEditScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildMetaInfoCard(themeProvider),
  ...
  Widget _buildMetaInfoCard(ThemeProvider themeProvider) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: themeProvider.surfaceColor,
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.store.updatedAt != null)
            _buildMetaItem(
              'Last Updated',
              _formatDate(widget.store.updatedAt!),
              Icons.update,
              themeProvider,
            ),
        ],
  ...
  Widget _buildMetaItem(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, size: 16, color: themeProvider.textSecondary),
      ...
      if (response['success'] == true) {
        ...
        if (mounted) {
          if (response['errors'] != null) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(response['message'] ?? 'Failed to update store'),
              ),
            );
          }
        }
