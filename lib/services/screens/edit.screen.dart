...
class _ServiceEditScreenState extends State<ServiceEditScreen> {
  ...
  void _initializeFields() {
    _namaController.text = widget.service.nama;
    _keteranganController.text = widget.service.keterangan ?? '';
    _hargaController.text = _formatNumber(
      widget.service.harga.toInt().toString(),
    );
    _durasiController.text = widget.service.durasi.toString();
    _selectedStoreId = widget.service.posTokoId;
  }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Update service details to improve your offerings',
                style: TextStyle(
  ...
  Future<void> _updateService() async {
    ...
    try {
      ...
      final response = await ServiceService.updateService(service);
